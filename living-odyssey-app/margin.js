 ...
 */
const WHO = {
  '':       { prefix: null },   // narration — the reader IS Ulysses telling the tale
  SELF:     { prefix: null, dash: true },
  /* Butler sets this speech in quotes INSIDE Ulysses' account and attributes
     it himself; the book drops each attribution into the prefix, which is
     presentation and not text — the words between the quotes stay byte-exact. */
  ULYSSES:      { prefix: 'Ulysses' },
  POLYPHEMUS:   { prefix: 'Polyphemus' },
  'A CYCLOPS':  { prefix: 'a Cyclops' },
  'THE MEN':    { prefix: 'the men' },
};
...
export class Margin {
   ...
   */
  progressEnd() {
    this.progEl.textContent = 'THE CYCLOPS · told by Ulysses';
  }
