...
## Run it
    python3 /Users/samz/Documents/gaslight-remake/app/serve.py
    open http://127.0.0.1:8150/app/index.html
Review lap: `node tools/lap.mjs <round>` (screenshots + all gates).
Asset regen: tools/nbpro.py, tools/nbpro_edit.py, tools/scenario3d.py,
tools/audiogen.py (keys parsed from story-orbit/.env in-Python; never printed).
